...
- **Design & Engineering:** Autodesk Inventor (API/iLogic), SolidWorks, CATIA V5, GD&T (ASME Y14.5 / ISO 1101), Industrial Metrology.
...
### [PointForge3D](https://github.com/javilesm/pointforge3d)
A cloud-native pipeline designed to convert 2D technical references into 3D point clouds. 
- **Tech:** Python, FastAPI, GCP G2 Instances.
- **Impact:** Automated the initial stage of reverse engineering for complex mechanical components.

### [Voxel Engine for CAD](https://github.com/javilesm/cad-voxel-engine)
Procedural terrain and geometry generator built within Autodesk Inventor.
- **Tech:** iLogic, VB.NET, PowerShell.
- **Impact:** Enabled massive data-set handling and metadata management for "chunk-based" 3D assemblies.
